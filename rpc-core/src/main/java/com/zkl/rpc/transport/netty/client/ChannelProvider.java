...
public class ChannelProvider {
    ...
    public static Channel get(InetSocketAddress inetSocketAddress, CommonSerializer serializer){
        ...
        try{
            connet(bootstrap,inetSocketAddress,countDownLatch);
    ...
    private static void connet(Bootstrap bootstrap, InetSocketAddress inetSocketAddress, CountDownLatch countDownLatch) {
